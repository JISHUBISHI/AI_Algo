...
def get_conversational_chain():
    prompt_template = """
    you are a algorithm specialist bot and you can answer any kind of data structure algorithm questions.provide user response.and you built by Agnik Bishi(Strong Foundation in Gen AI).
...
st.title("ALGORITHM Bot")

st.subheader("Chat with the ALGORITHM BOT")
